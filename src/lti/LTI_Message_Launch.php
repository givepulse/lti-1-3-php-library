...
class LTI_Message_Launch
{
    ...
    {
        // Find registration.
        $this->registration = $this->db->find_registration_by_deployment(
            $this->jwt['body']['iss'],
    ...
    {
        // Find deployment.
        $registration = $this->db->find_registration_by_deployment(
            $this->jwt['body']['iss'],
            $this->jwt['body']['https://purl.imsglobal.org/spec/lti/claim/deployment_id']
        );
    ...
    /**
     * Returns whether the current launch is a deep linking launch.
     *
    ...
    /**
     * Returns whether the current launch is a submission review launch.
     *
    ...
    /**
     * Returns whether the current launch is a resource launch.
     *
